...
return [
    ...
    */
    ...
    'date_equals'          => ':attributeは:dateと一致する日付を指定してください。',
    ...
    'ends_with'            => ':attributeには:valuesを末尾にもつ文字列を指定して下さい。',
    'exists'               => '指定された:attributeは存在しません。',
    'file'                 => ':attributeにはファイルを指定してください。',
    'filled'               => ':attributeには空でない値を指定してください。',
    'gt'                   => [
        'numeric' => ':attributeには:valueよりの大きい数値を指定してください。',
        'file'    => ':attributeには:value KBより大きいファイルを指定してください。',
        'string'  => ':attributeには:value文字より長い文字列を指定してください。',
        'array'   => ':attributeには:value個より多いい要素を持つ配列を指定してください。',
    ],
    'gte'                  => [
    ...
    'lt'                   => [
        'numeric' => ':attributeには:valueよりの小さい数値を指定してください。',
        'file'    => ':attributeには:value KBより小さいファイルを指定してください。',
        'string'  => ':attributeには:value文字より長い文字列を指定してください。',
        'array'   => ':attributeには:value個より少ない要素を持つ配列を指定してください。',
    ],
    'lte'                  => [
    ...
    'starts_with'          => ':attributeには:valuesから始まる文字列を指定してください。',
